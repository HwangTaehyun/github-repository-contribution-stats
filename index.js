...
const createTextNode = ({ imageUrl, name, rank, index, height }) => {
    ...
    let offset = (0,_common_utils__WEBPACK_IMPORTED_MODULE_3__.clampValue)(calculateTextWidth(name), 180, 400);
    ...
    <g class="stagger" style="animation-delay: ${staggerDelay}ms" transform="translate(25, 0)">
      ...
      <image xlink:href="${escape_html__WEBPACK_IMPORTED_MODULE_6___default()(imageUrl)}" width="25" height="25" clip-path="url(#myCircle)"/>
...
const renderContributorStatsCard = async (name, contributorStats = [], options = {}) => {
    ...
    const transformedContributorStats = contributorStats
        ...
        return {
            ...
            rank: (0,_calculateRank__WEBPACK_IMPORTED_MODULE_0__.calculateRank)(stargazerCount),
        };
    })
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "fetchContributorStats": () => (/* binding */ fetchContributorStats)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "calculateCircleProgress": () => (/* binding */ calculateCircleProgress),
/* harmony export */   "getAnimations": () => (/* binding */ getAnimations),
/* harmony export */   "getProgressAnimation": () => (/* binding */ getProgressAnimation),
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "availableLocales": () => (/* binding */ availableLocales),
/* harmony export */   "isLocaleAvailable": () => (/* binding */ isLocaleAvailable),
/* harmony export */   "langCardLocales": () => (/* binding */ langCardLocales),
/* harmony export */   "repoCardLocales": () => (/* binding */ repoCardLocales),
/* harmony export */   "statCardLocales": () => (/* binding */ statCardLocales),
/* harmony export */   "wakatimeCardLocales": () => (/* binding */ wakatimeCardLocales)
/* harmony export */ });
/* harmony import */ var _common_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/common/utils */ "./src/common/utils.ts");

const statCardLocales = ({ name, apostrophe }) => {
    const encodedName = (0,_common_utils__WEBPACK_IMPORTED_MODULE_0__.encodeHTML)(name);
    return {
        'statcard.title': {
...
app.get('/api', async (req, res) => {
    ...
    try {
        ...
        res.send(await (0,_cards_stats_card__WEBPACK_IMPORTED_MODULE_0__.renderContributorStatsCard)(name, contributorStats, {
